    ...
    <view class="detailWrap">
      <view class="titleWrap">
        ...
        <view class="desc">
          <view class="time">
            <u-icon
              :name="staticurl('/course/audioplayer.svg')"
              size="36"
            ></u-icon>
          </view>
      ...
      <view class="detail-action-bar">
        <view class="action-buttons">
          <button class="btn-share" open-type="share">
            <u-icon
              :name="staticurl('/course/shareico.svg')"
              size="56"
            ></u-icon>
            分享
          </button>
...
export default {
  data() {
    return {
      ...
      videoPoster:
        "https://yanliangliang.com/static/images/course/meditationlist_img1.jpg",
      archivesInfo: {},
	  isCollect: false
    };
  },
